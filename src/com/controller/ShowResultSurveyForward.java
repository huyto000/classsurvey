...
@WebServlet("/ShowResultSurveyForward")
public class ShowResultSurveyForward extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ShowResultSurveyForward() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("views/home_teacher_resultsurvey.jsp");
