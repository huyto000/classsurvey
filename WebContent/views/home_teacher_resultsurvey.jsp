    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" id = "fixnav" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="HomeTeacherForward"><b>Class Survey</b></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i> <b>${memberTeacher.getFullname()}</b> <i class="fa fa-caret-down"></i>
                    </a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav in" id="side-menu">
                        <li>
                            <a href="ShowResultSurveyForward"><i class="fa fa-graduation-cap fa-fw"></i> Xem thông tin đánh giá</a>
                        </li>
			...
			<div class="col-lg-10 ajax-area">
				<div class="row">
					<div class="panel panel-default">
						<h1 align="center">Danh sách môn học đăng kí giảng dạy</h1>
					</div>
					<table class="table table-striped" border="1">
						...
						<tbody>
							<c:forEach items="${listCourseOfTeacher}" var="lct">
								<tr>
									<td>${lct.courseId}</td>
									<td>${lct.courseName}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
					
					<form action="ShowResultSurveyController" method="POST">
					
						<p><b>Chọn môn học</b></p>
						<select name="course">
							<c:forEach items="${listCourseOfTeacher}" var="lct">
								<option value="${lct.courseId}">${lct.courseName}</option>
							</c:forEach>
						</select> 
						<input style="background-color: #74DF00" type="submit" value="Xem kết quả">
